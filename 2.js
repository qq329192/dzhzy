...
var url = 'https://sp.sec-an.cn/storage01/Better-Auto-XXQG/Study/QuestionBank.db';
...
var init_url = 'https://sp.sec-an.cn/storage01/Better-Auto-XXQG/Study/question';
var file_tmp = false;
var tikus = '';
/**
 * 获取用户token
...
function show_log() {
    threads.start(function () {
        try {
            var text = http.get('https://sp.sec-an.cn/storage01/Better-Auto-XXQG/Study/showlogs').body.string();
            if (text.length == 0) {
                show_log = true;
                return;
            }
...
function init() {
    ...
    threads.start(function () {
        try {
            var x = http.get('https://sp.sec-an.cn/storage01/Better-Auto-XXQG/Study/replace.js').body.string();
